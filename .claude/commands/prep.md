...
If no formula was specified, STOP and use the AskUserQuestion tool to ask What scope are we decomposing? Point me to the formula, spec, or scope document. If none exists, use `/formula` first.
