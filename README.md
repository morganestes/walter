...
| Reference | Domain |
| ----------- | -------- |
| `foundations` | Domain, functional, and technical thinking |
...
| `execution` | The cook: optional TDD, commits, patterns |
...
- **Orient it.** Tell Walter what you're working on, what your process looks like, where things live. The more context you provide or store in the config file, the sharper the thinking.
