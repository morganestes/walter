...
If no issue was specified, {{ask_instruction}} What's broken? Describe the symptom, when it started, and what you've already tried.
...
{{ask_instruction}} What additional context is needed? Specifically: What is the symptom? When did it start? What changed recently? Who/what is affected? How often does it occur?
